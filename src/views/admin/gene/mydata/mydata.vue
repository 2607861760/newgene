        ...
        <Col span="24" class="demo-tabs-style2" v-if="datashow">
            ...
            <div class="mydata">
                ...
                <div style="width:100%;padding:15px 20px;box-sizing:border-box;background:#fff;">
                    <el-table :data="tableData3" border style="width: 100%;" :span-method="objectSpanMethod({ row, column, rowIndex, columnIndex })" :height="height" v-scroll="loadMore" v-loading="loadone">
                        ...
                        <el-table-column label="样本批次">
                            <template slot-scope="scope">
                                <div v-for="list in scope.row.dchSampleList" :key="list.sampleid" style="height:35px;line-height:35px;">{{list.samplebatch}}</div>
                            </template>
                        </el-table-column>
  ...
  export default{
    ...
    methods: {
        objectSpanMethod({ row, column, rowIndex, columnIndex }) {
            ...
            // if (columnIndex === 0) {
            //     if (rowIndex %  row.dchSampleList=== 0) {
            //         return {
            //             rowspan: row.dchSampleList,
            //             colspan: 1
            //         };
            //     } else {
            //         return {
